        ...
        <style jsx>{`
          .stars-background {
            background-image: 
              ...
              radial-gradient(2px 2px at 40px 70px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 120px 40px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(1px 1px at 140px 90px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 230px 150px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 420px 190px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 350px 290px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(1px 1px at 390px 320px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 450px 380px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 520px 400px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 600px 350px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(1px 1px at 550px 290px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 700px 370px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 250px 350px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 300px 370px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(1px 1px at 320px 400px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 900px 300px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 830px 350px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 950px 380px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(1px 1px at 1000px 400px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 750px 100px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 800px 150px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(1px 1px at 750px 200px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 850px 90px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 650px 130px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(1px 1px at 600px 200px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 550px 150px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0)),
              radial-gradient(3px 3px at 500px 100px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(1px 1px at 950px 190px, rgba(255, 233, 174, 0.9), rgba(255, 233, 174, 0)),
              radial-gradient(2px 2px at 1000px 150px, rgba(255, 233, 174, 0.85), rgba(255, 233, 174, 0));
